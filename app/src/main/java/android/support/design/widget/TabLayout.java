...
public class TabLayout extends HorizontalScrollView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mMode == 1 && getChildCount() == 1) {
            ...
            if (child.getMeasuredWidth() > width) {
                ...
                int childWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(width, 1073741824);
    ...
    private void animateToTab(int newPosition) {
        ...
        if (newPosition != -1) {
            ...
            if (startScrollX != targetScrollX) {
                ...
                animator.setUpdateListener(new ValueAnimatorCompat.AnimatorUpdateListener() { // from class: android.support.design.widget.TabLayout.2
                    @Override // android.support.design.widget.ValueAnimatorCompat.AnimatorUpdateListener
                    public void onAnimationUpdate(ValueAnimatorCompat animator2) {
                        TabLayout.this.scrollTo(animator2.getAnimatedIntValue(), 0);
                    }
                });
                animator.start();
            }
    ...
    private int calculateScrollXForTab(int position, float positionOffset) {
        ...
        return (int) (((selectedChild.getLeft() + (((selectedWidth + nextWidth) * positionOffset) * 0.5f)) + (selectedChild.getWidth() * 0.5f)) - (getWidth() * 0.5f));
    }
    ...
    class TabView extends LinearLayout implements View.OnLongClickListener {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (TabLayout.this.mTabMaxWidth == 0 || getMeasuredWidth() <= TabLayout.this.mTabMaxWidth) {
                if (TabLayout.this.mTabMinWidth > 0 && getMeasuredHeight() < TabLayout.this.mTabMinWidth) {
