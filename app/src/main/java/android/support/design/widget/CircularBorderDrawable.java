...
class CircularBorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        int[] colors = {this.mTopOuterStrokeColor, this.mTopInnerStrokeColor, ColorUtils.setAlphaComponent(this.mTopInnerStrokeColor, 0), ColorUtils.setAlphaComponent(this.mBottomInnerStrokeColor, 0), this.mBottomInnerStrokeColor, this.mBottomOuterStrokeColor};
