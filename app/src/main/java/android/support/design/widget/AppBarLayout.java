...
public class AppBarLayout extends LinearLayout {
    ...
    public void removeOnOffsetChangedListener(OnOffsetChangedListener listener) {
        ...
        while (i.hasNext()) {
            ...
            OnOffsetChangedListener item = ref.get();
    ...
    public static class Behavior extends ViewOffsetBehavior<AppBarLayout> {
        ...
        private void dispatchOffsetUpdates(AppBarLayout layout) {
            ...
            for (int i = 0; i < z; i++) {
                ...
                OnOffsetChangedListener listener = ref != null ? ref.get() : null;
                if (listener != null) {
        ...
        public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
            ...
            if (child.getLayoutParams().height == -1) {
                ...
                if (!dependencies.isEmpty() && (appBar = findFirstAppBarLayout(dependencies)) != null && ViewCompat.isLaidOut(appBar)) {
                    ...
                    int heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(height, Integer.MIN_VALUE);
        ...
        public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
            ...
            if (behavior instanceof Behavior) {
                ...
                if (this.mOverlayTop != 0 && (dependency instanceof AppBarLayout)) {
                    ...
                    setTopAndBottomOffset(AnimationUtils.lerp(expandedMax, collapsedMin, Math.abs(appBarOffset) / scrollRange));
                    return false;
                }
