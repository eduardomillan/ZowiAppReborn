...
public class TextInputLayout extends LinearLayout {
    ...
    private LinearLayout.LayoutParams setEditText(EditText editText, ViewGroup.LayoutParams lp) {
        ...
        this.mEditText.addTextChangedListener(new TextWatcher() { // from class: android.support.design.widget.TextInputLayout.2
        ...
        this.mEditText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: android.support.design.widget.TextInputLayout.3
    ...
    public void setError(CharSequence error) {
        ...
        if (!TextUtils.isEmpty(error)) {
            ...
            ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200L).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.design.widget.TextInputLayout.4
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mAnimator == null) {
            ...
            this.mAnimator.setUpdateListener(new ValueAnimatorCompat.AnimatorUpdateListener() { // from class: android.support.design.widget.TextInputLayout.5
