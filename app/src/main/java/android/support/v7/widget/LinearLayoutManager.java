...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler {
    ...
    static class LayoutState {
        ...
        public void assignPositionFromScrapList(RecyclerView.ViewHolder ignore) {
            ...
            this.mCurrentPosition = closest == null ? -1 : closest.getLayoutPosition();
        }
        ...
        public RecyclerView.ViewHolder nextViewHolderInLimitedList(RecyclerView.ViewHolder ignore) {
            ...
            for (int i = 0; i < size; i++) {
                RecyclerView.ViewHolder viewHolder = this.mScrapList.get(i);
                if (viewHolder != ignore && !viewHolder.isRemoved() && (distance = (viewHolder.getLayoutPosition() - this.mCurrentPosition) * this.mItemDirection) >= 0 && distance < closestDistance) {
                    closest = viewHolder;
