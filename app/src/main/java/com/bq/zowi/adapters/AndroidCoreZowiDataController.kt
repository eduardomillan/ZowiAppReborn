...
class AndroidCoreZowiDataController(
    ...
    private fun parseMessage(message: String) {
        try {
            ...
            Grove.d(e, "Failed to parse message: $message")
        }
    }
    ...
    override fun waitForBatteryLevelReception(): Single<Float> = batterySubject.firstOrError()
    override fun waitForDistanceLevelReception(): Single<Int> = distanceSubject.firstOrError()
    override fun waitForNoiseLevelReception(): Single<Int> = noiseSubject.firstOrError()
    override fun waitForZowiAppIdReception(): Single<String> = appIdSubject.firstOrError()
    override fun waitForZowiNameReception(): Single<String> = nameSubject.firstOrError()
