...
public class AchievementsWireframeImpl extends InteractiveWireframeImpl implements AchievementsWireframe {
    public AchievementsWireframeImpl(FragmentActivity activity) {
        super(activity);
    }

    @Override // com.bq.zowi.wireframes.achievements.AchievementsWireframe
