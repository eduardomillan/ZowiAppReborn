...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C0042zza implements zzt {
        ...
        public static zzt zzaL(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzt)) ? new C0042zza(iBinder) : (zzt) iInterfaceQueryLocalInterface;
        }
