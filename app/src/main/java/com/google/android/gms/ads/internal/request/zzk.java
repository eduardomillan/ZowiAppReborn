...
public interface zzk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzk {
        ...
        private static class C0020zza implements zzk {
        ...
        public static zzk zzY(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzk)) ? new C0020zza(iBinder) : (zzk) iInterfaceQueryLocalInterface;
        }
