...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C0039zza implements zzq {
        ...
        public static zzq zzaI(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzq)) ? new C0039zza(iBinder) : (zzq) iInterfaceQueryLocalInterface;
        }
