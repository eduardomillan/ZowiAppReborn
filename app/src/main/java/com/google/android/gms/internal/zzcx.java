...
public interface zzcx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcx {
        ...
        private static class C0058zza implements zzcx {
        ...
        public static zzcx zzA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcx)) ? new C0058zza(iBinder) : (zzcx) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzcs.zza.zzx(data.readStrongBinder()));
