        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    zza(data.readString(), data.createTypedArrayList(Scope.CREATOR), zzf.zza.zzdN(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.signin.internal.IOfflineAccessCallbacks");
                    zza(data.readString(), data.readString(), zzf.zza.zzdN(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
