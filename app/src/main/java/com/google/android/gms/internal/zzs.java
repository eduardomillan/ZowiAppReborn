...
public class zzs {
    ...
    static class zza {
        ...
        private final List<C0095zza> zzal = new ArrayList();
        ...
        private static class C0095zza {
            public final String name;
            public final long time;
            public final long zzan;

            public C0095zza(String str, long j, long j2) {
                this.name = str;
                this.zzan = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzal.add(new C0095zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (jZzx > 0) {
                ...
                long j2 = j;
                for (C0095zza c0095zza : this.zzal) {
                    long j3 = c0095zza.time;
                    zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(c0095zza.zzan), c0095zza.name);
                    j2 = j3;
                }
            }
        }
