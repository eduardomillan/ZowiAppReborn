...
public interface zzeo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeo {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzeo$zza$zza, reason: collision with other inner class name */
        private static class C0068zza implements zzeo {
            ...
            public void zza(zzep zzepVar) throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    parcelObtain.writeStrongBinder(zzepVar != null ? zzepVar.asBinder() : null);
        ...
        public static zzeo zzG(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzeo)) ? new C0068zza(iBinder) : (zzeo) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 7:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    zza(zzep.zza.zzH(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
