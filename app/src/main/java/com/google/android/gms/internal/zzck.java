...
public interface zzck extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzck {
        ...
        private static class C0050zza implements zzck {
            ...
            public void zza(zzcj zzcjVar) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeStrongBinder(zzcjVar != null ? zzcjVar.asBinder() : null);
        ...
        public static zzck zzs(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzck)) ? new C0050zza(iBinder) : (zzck) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzcj.zza.zzr(data.readStrongBinder()));
