...
public interface zzp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzp {
        ...
        private static class C0038zza implements zzp {
        ...
        public static zzp zzaH(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzp)) ? new C0038zza(iBinder) : (zzp) iInterfaceQueryLocalInterface;
        }
