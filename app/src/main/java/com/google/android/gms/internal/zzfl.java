...
public interface zzfl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfl {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzfl$zza$zza, reason: collision with other inner class name */
        private static class C0073zza implements zzfl {
        ...
        public static zzfl zzM(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfl)) ? new C0073zza(iBinder) : (zzfl) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder iBinderZze = zze(zzd.zza.zzbk(data.readStrongBinder()));
