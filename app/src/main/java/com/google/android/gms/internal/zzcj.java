...
public interface zzcj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcj {
        ...
        private static class C0049zza implements zzcj {
        ...
        public static zzcj zzr(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcj)) ? new C0049zza(iBinder) : (zzcj) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 3:
                    data.enforceInterface("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
                    zza(zzd.zza.zzbk(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
