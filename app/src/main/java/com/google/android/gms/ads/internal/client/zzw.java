...
public interface zzw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzw {
        ...
        private static class C0014zza implements zzw {
        ...
        public static zzw zzo(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzw)) ? new C0014zza(iBinder) : (zzw) iInterfaceQueryLocalInterface;
        }
