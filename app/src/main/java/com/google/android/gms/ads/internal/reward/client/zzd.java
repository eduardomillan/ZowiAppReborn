...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class C0026zza implements zzd {
        ...
        public static zzd zzac(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzd)) ? new C0026zza(iBinder) : (zzd) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAdListener");
                    zza(zza.AbstractBinderC0022zza.zzZ(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAdListener");
