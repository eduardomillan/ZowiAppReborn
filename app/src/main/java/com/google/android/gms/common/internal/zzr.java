...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C0040zza implements zzr {
        ...
        public static zzr zzaJ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzr)) ? new C0040zza(iBinder) : (zzr) iInterfaceQueryLocalInterface;
        }
