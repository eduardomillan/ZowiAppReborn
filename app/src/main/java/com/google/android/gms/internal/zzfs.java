...
public interface zzfs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfs {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzfs$zza$zza, reason: collision with other inner class name */
        private static class C0076zza implements zzfs {
            ...
            public void zza(zzfr zzfrVar) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeStrongBinder(zzfrVar != null ? zzfrVar.asBinder() : null);
        ...
        public static zzfs zzP(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfs)) ? new C0076zza(iBinder) : (zzfs) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzfr.zza.zzO(data.readStrongBinder()));
