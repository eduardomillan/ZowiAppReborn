...
public interface zzo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzo {
        ...
        private static class C0006zza implements zzo {
        ...
        public static zzo zzg(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzo)) ? new C0006zza(iBinder) : (zzo) iInterfaceQueryLocalInterface;
        }
