...
public class zzbp {
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        while (true) {
            ...
            jZzb = zza(zzbn.zzC(strArr[i4 - 1]), zzbn.zzC(strArr[(i4 + i2) - 1]), jZzb, jZza, 16785407L);
    ...
    private static long zzb(String[] strArr, int i, int i2) {
        long jZzC = (((long) zzbn.zzC(strArr[i])) + 2147483647L) % 1073807359;
        for (int i3 = i + 1; i3 < i + i2; i3++) {
            jZzC = (((jZzC * 16785407) % 1073807359) + ((((long) zzbn.zzC(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZzC;
    }
}
