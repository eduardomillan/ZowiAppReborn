...
public class SearchAuth {
    private static final Api.zza<zzqs, Api.ApiOptions.NoOptions> zzaUP = new Api.zza<zzqs, Api.ApiOptions.NoOptions>() { // from class: com.google.android.gms.search.SearchAuth.1
