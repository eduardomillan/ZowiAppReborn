...
public class zza {
    ...
    public static class C0037zza extends RuntimeException {
        public C0037zza(String str, Parcel parcel) {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        int iZza = zza(parcel, i);
        if (iZza != i2) {
            throw new C0037zza("Expected size " + i2 + " got " + iZza + " (0x" + Integer.toHexString(iZza) + ")", parcel);
        }
    }

    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new C0037zza("Expected size " + i3 + " got " + i2 + " (0x" + Integer.toHexString(i2) + ")", parcel);
        }
    }
    ...
    public static int zzap(Parcel parcel) {
        ...
        int iDataPosition = parcel.dataPosition();
        if (zzbM(iZzao) != 20293) {
            throw new C0037zza("Expected object header. Got 0x" + Integer.toHexString(iZzao), parcel);
        }
        int i = iDataPosition + iZza;
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new C0037zza("Size read is invalid start=" + iDataPosition + " end=" + i, parcel);
        }
        return i;
    }
