...
public interface zzfv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfv {
        ...
        private static class C0079zza implements zzfv {
        ...
        public static zzfv zzS(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfv)) ? new C0079zza(iBinder) : (zzfv) iInterfaceQueryLocalInterface;
        }
