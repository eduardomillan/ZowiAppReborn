...
public class comScore {
    ...
    public static void aggregate(HashMap<String, String> map) {
        a.notify(EventType.AGGREGATE, map, true);
    }
    ...
    public static void hidden(HashMap<String, String> map) {
        a.notify(EventType.HIDDEN, map, true);
    }
    ...
    public static void setAutoStartLabels(HashMap<String, String> map) {
        a.setAutoStartLabels(map);
    }
    ...
    public static void setLabels(HashMap<String, String> map) {
        a.setLabels(map, true);
    }
    ...
    public static void start(HashMap<String, String> map) {
        a.notify(EventType.START, map, true);
    }
    ...
    public static void view(HashMap<String, String> map) {
        a.notify(EventType.VIEW, map, true);
    }
